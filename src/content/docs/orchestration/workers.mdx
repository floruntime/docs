...
- **Stream workers** — consume records from a [stream](/data/streams/) via consumer groups, process each record, and auto-ack or nack. Used for continuous event processing.
...
- [Streams](/data/streams/) — Append-only ordered log with consumer groups
