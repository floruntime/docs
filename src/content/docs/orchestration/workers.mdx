...
- **Stream workers** — consume records from a [stream](/docs/primitives/streams/) via consumer groups, process each record, and auto-ack or nack. Used for continuous event processing.
...
- [Actions](/docs/orchestration/actions/) — Register and invoke durable task types
- [Streams](/docs/primitives/streams/) — Append-only ordered log with consumer groups
- [Workflows](/docs/orchestration/workflows/) — Multi-step orchestration using actions as steps
- [Stream Processing](/docs/orchestration/processing/) — Declarative stream processing jobs
