---
title: Queues
lede: Priority queues with competing consumers, lease-based delivery, DLQ, blocking dequeue, and visibility timeouts.
---
...
The response returns the assigned sequence number. A message takes at most 64 KiB.
...
# 0 does not wait)
flo queue dequeue tasks --block 300000
```
