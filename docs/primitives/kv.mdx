...
| Flag | Description |
|------|-------------|
| `--wait <ms>` | Wait until the key exists, then return (0 = the 5-minute maximum) |
| `--block <ms>` | Wait for the **next version change**, even if the key already exists (0 = the 5-minute maximum) |
