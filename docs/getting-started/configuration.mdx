...
shards = 0                # Number of shards, at most 256 (0 = auto-detect CPU count)
# partition_count = 0     # Virtual partitions, at most 16384 (0 = auto: max(4096, shards × 32))
```
...
silently ignored. See [Clustering](/deployment/clustering).
